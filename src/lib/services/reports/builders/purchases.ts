...
export async function buildPurchasesSupplierStatement(
  ...
  return {
    ...
    columns: [
      ...
      { key: 'ref', label: 'Ref', width: 0.09, format: 'text', excelWidth: 10 },
      { key: 'price', label: 'Price Incl', width: 0.11, align: 'right', format: 'money', excelWidth: 12 },
      { key: 'wbFull', label: 'WB Full', width: 0.1, align: 'right', format: 'mass', excelWidth: 10 },
      { key: 'wbEmpty', label: 'WB Empty', width: 0.1, align: 'right', format: 'mass', excelWidth: 10 },
      { key: 'mass', label: 'Nett Mass', width: 0.11, align: 'right', format: 'mass', excelWidth: 11 },
      { key: 'subTotal', label: 'Sub Total', width: 0.13, align: 'right', format: 'money', excelWidth: 13 },
      { key: 'vat', label: 'VAT', width: 0.1, align: 'right', format: 'money', excelWidth: 11 },
      { key: 'grandTotal', label: 'Grand Total', width: 0.15, align: 'right', format: 'money', excelWidth: 14 },
    ],
    groups,
    grandTotal,
...
export async function buildPurchasesPerProductDay(
  ...
  return {
    ...
    columns: [
      { key: 'date', label: 'Date', width: 0.14, format: 'datetime', excelWidth: 16 },
      { key: 'ref', label: 'Trans No.', width: 0.09, format: 'text', excelWidth: 10 },
      { key: 'supplier', label: 'Company', width: 0.22, format: 'text', excelWidth: 24 },
      { key: 'price', label: 'Price Incl.', width: 0.11, align: 'right', format: 'money', excelWidth: 12 },
      { key: 'qty', label: 'Qty', width: 0.1, align: 'right', format: 'mass', excelWidth: 10 },
      { key: 'subTotal', label: 'Sub Total', width: 0.12, align: 'right', format: 'money', excelWidth: 13 },
      { key: 'vat', label: 'VAT', width: 0.09, align: 'right', format: 'money', excelWidth: 11 },
      { key: 'grandTotal', label: 'Grand Total', width: 0.13, align: 'right', format: 'money', excelWidth: 14 },
    ],
    groups,
    grandTotal,
    meta: { ...meta, rowCount: countDataRows(groups) },
