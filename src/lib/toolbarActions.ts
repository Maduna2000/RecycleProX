import {
  ...
  SlidersHorizontal, ShieldCheck, History, Ban, CheckCircle, RefreshCw,
...
export const TOOLBAR_ACTIONS: ToolbarAction[] = [
  ...
  // ── Compliance ────────────────────────────────────────────────────────
  // Generate Register/Visit History used to be a PortalPage tab strip on
  // one route — split into two routes (police-register + /history) and
  // moved here, same pure-navigation pattern as Stock/Gate/Scale above.
  { id: 'generate-register', label: 'Generate Register', icon: ClipboardList, group: 'Compliance',
    routes: ['/app/police-register/'], href: '/app/police-register' },
  { id: 'visit-history', label: 'Visit History', icon: History, group: 'Compliance',
    routes: ['/app/police-register/'], href: '/app/police-register/history' },
