  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 90 }}>
      ...
      <div style={{ position: 'absolute', top: 0, right: 0, bottom: 0, width: '100%', maxWidth, background: '#fff', boxShadow: '-4px 0 24px rgba(0,0,0,0.25)', display: 'flex', flexDirection: 'column' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 16px', borderBottom: '2px solid #B0B0B0', background: BAR_GRAD, flexShrink: 0 }}>
